...
namespace WinFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            TimeBoxzz1.BackColor = SystemColors.ActiveCaption;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (TimeBoxzz1.Text == "00:00:01")
            {
                ...
                MessageBox.Show("시간 종료", "1번 컴퓨터", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void button1_2_Click(object sender, EventArgs e)
        {
            ...
            TimeBoxzz1.BackColor = SystemColors.Control;
        ...
        {
            TimeBoxzz2.BackColor = SystemColors.ActiveCaption;
            if (flagzz2 == 1)
            {
        ...
        private void buttonzz2_2_Click(object sender, EventArgs e)
        {
            ...
            TimeBoxzz2.BackColor = SystemColors.Control;
        ...
        private void timerzz2_Tick(object sender, EventArgs e)
        {
            ...
            {
                timerzz2.Stop();
                MessageBox.Show("시간 종료", "2번 컴퓨터", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        {
            TimeBoxzz3.BackColor = SystemColors.ActiveCaption;
            if (flagzz3 == 1)
            {
        ...
        private void buttonzz3_1_Click(object sender, EventArgs e)
        {
            ...
            TimeBoxzz3.BackColor = SystemColors.Control;
        ...
        private void timerzz3_Tick(object sender, EventArgs e)
        {
            ...
            {
                timerzz3.Stop();
                MessageBox.Show("시간 종료", "3번 컴퓨터", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        {
            TimeBoxzz4.BackColor = SystemColors.ActiveCaption;
            if (flagzz4 == 1)
            {
        ...
        private void buttonzz4_1_Click(object sender, EventArgs e)
        {
            ...
            TimeBoxzz4.BackColor = SystemColors.Control;
            buttonzz4.Text = "▶";
        ...
        private void timerzz4_Tick(object sender, EventArgs e)
        {
            ...
            {
                timerzz4.Stop();
                MessageBox.Show("시간 종료", "4번 컴퓨터", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        {
            TimeBoxzz5.BackColor = SystemColors.ActiveCaption;
            if (flagzz5 == 1)
            {
        ...
        {
            timerzz5.Stop();
            TimeBoxzz5.BackColor = SystemColors.Control;
        ...
        private void timerzz5_Tick(object sender, EventArgs e)
        {
            ...
            {
                timerzz5.Stop();
                MessageBox.Show("시간 종료", "닌텐도", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        {
            TimeBoxzz6.BackColor = SystemColors.ActiveCaption;
            if (flagzz6 == 1)
            {
        ...
        private void buttonzz6_1_Click(object sender, EventArgs e)
        {
            ...
            TimeBoxzz6.BackColor = SystemColors.Control;
        ...
        private void timerzz6_Tick(object sender, EventArgs e)
        {
            ...
            {
                timerzz6.Stop();
                MessageBox.Show("시간 종료", "노래방", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        {
            TimeBoxzz7.BackColor = SystemColors.ActiveCaption;
            if (flagzz7 == 1)
            {
                if (InputTimezz7.Text == "")
                {
                    nowzz7 = DateTime.Now.AddMinutes(30);
        ...
        {
            timerzz7.Stop();
            TimeBoxzz7.BackColor = SystemColors.Control;
        ...
        private void timerzz7_Tick(object sender, EventArgs e)
        {
            ...
            {
                timerzz7.Stop();
                MessageBox.Show("시간 종료", "패드민턴", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        {
            TimeBoxzz8.BackColor = SystemColors.ActiveCaption;
            if (flagzz8 == 1)
            {
        ...
        private void buttonzz8_1_Click(object sender, EventArgs e)
        {
            ...
            timerzz8.Stop();
            TimeBoxzz8.BackColor = SystemColors.Control;
        ...
        private void timerzz8_Tick(object sender, EventArgs e)
        {
            ...
            {
                timerzz8.Stop();
                MessageBox.Show("시간 종료", "", MessageBoxButtons.OK, MessageBoxIcon.Warning);
